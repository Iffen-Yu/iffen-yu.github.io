...
$\bullet$ Factor Rewriting: Numpy vectorization of python code with partial autocorrelation coefficient, continuous wavelet transform, sample entropy, etc., used Numba to achieve code acceleration.
